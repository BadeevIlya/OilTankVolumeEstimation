...
def processing(data, mode):
	OUTPUT_IMAGE_FILE = Path(WORKING_PATH / 'datasets' /'Yolo_GoogleOilStorage_x2' / 'images' / mode)
	OUTPUT_LABEL_FILE = Path(WORKING_PATH / 'datasets' /'Yolo_GoogleOilStorage_x2' / 'labels' / mode)
